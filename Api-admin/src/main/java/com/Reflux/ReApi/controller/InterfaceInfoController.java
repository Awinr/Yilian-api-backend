...
import com.Reflux.ReApi.common.*;
...
import com.Reflux.ReApi.model.request.InterfaceInfo.InterfaceInfoAddRequest;
 ...
 /*
    ...
    */
    ...
    public void getSdk(HttpServletResponse response) throws IOException {
        // 获取要下载的文件
        org.springframework.core.io.Resource resource = new ClassPathResource("Api-client-sdk-0.0.1-SNAPSHOT.jar");
