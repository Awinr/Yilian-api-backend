...
import com.Reflux.ReApi.mapper.PostFavourMapper;
import com.Reflux.ReApi.mapper.PostMapper;
import com.Reflux.ReApi.mapper.PostThumbMapper;
import com.Reflux.ReApi.model.EsDTO.PostEsDTO;

import com.Reflux.ReApi.model.request.post.PostQueryRequest;

import com.Reflux.ReApi.service.PostService;
import com.Reflux.ReApi.service.UserService;
import com.Reflux.ReApi.model.entity.Post;
import com.Reflux.ReApi.model.entity.PostFavour;
...
import com.Reflux.ReApi.model.vo.PostVO;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public PostVO getPostVO(Post post, HttpServletRequest request) {
        ...
        // 2. 已登录，获取用户点赞、收藏状态
        LoginUserVO loginUser = userService.getLoginUserByThreadLocalPermitNull();
        if (loginUser != null) {
            // 获取点赞
    ...
    public Page<PostVO> getPostVOPage(Page<Post> postPage, HttpServletRequest request) {
        ...
        if (loginUser != null) {
            ...
            loginUser = userService.getLoginUserByThreadLocal();
            // 获取点赞
            QueryWrapper<PostThumb> postThumbQueryWrapper = new QueryWrapper<>();
